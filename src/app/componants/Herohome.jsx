...
const Herohome = () => {
  ...
  return (
    <section className='py-6 sm:py-8 md:py-10 lg:py-12 grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 px-3 sm:px-4 md:px-6 lg:px-8'>
      ...
      <div className='border shadow-[2px_2px_10px_black] rounded-3xl sm:rounded-[40px] lg:rounded-[50px] flex items-center overflow-hidden w-full cursor-grab'>
        <div className='w-full space-y-4 transform rotate-[-40deg] scale-160'>
          <Marquee
            gradient={false}
            speed={25}
            direction='right'
            ...
            <div className='flex items-center text-white space-x-4 sm:space-x-6 md:space-x-8'>
              {[1, 2, 3, 4, 5, 6, 7].map(item => (
                <Image
                  ...
                  width={150}
                  height={100}
                  className='object-contain h-12 sm:h-14 md:h-16 lg:h-30 w-auto shadow-[4px_4px_10px_black]'
                />
              ))}
            </div>
          </Marquee>
